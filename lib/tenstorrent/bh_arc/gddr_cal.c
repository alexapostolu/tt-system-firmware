...
#elif IS_ENABLED(CONFIG_TT_BH_ARC_GDDR_CA_LATCH) && !IS_ENABLED(CONFIG_TT_BH_ARC_EMUL)
#error "CONFIG_TT_BH_ARC_GDDR_CA_LATCH requires gddrcal_a and gddrcal_b in the devicetree"
#else /* Kconfig off, partitions absent, or emul/native_sim without those nodes */
